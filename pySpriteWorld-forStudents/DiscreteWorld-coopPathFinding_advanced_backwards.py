...
class true_Distance:
    """ classe pour calculer la true distance"""
...
def spaceTime_astar(initState, goalState, wallStates,obstacles, time , reservations=[]):
    """ application de l'algorithme a-star spatio temporel
        """
    ...
    while frontiere != [] and not (goalState==(bestNoeud.x, bestNoeud.y)):              
        ...
        if str(bestNoeud.x) + " " + str(bestNoeud.y) + " " + str(bestNoeud.t) not in reserve:            
            ...
            for n in nouveauxNoeuds:
                if (((n.x,n.y) not in wallStates + obstacles )and n.x>=0 and n.x< nbColonnes and n.y>=0 and n.y< nbColonnes and (n.x, n.y, n.t) not in reservations):
...
def main():
    print("======================================================")
    print("|  cooperative pathfinding advanced true distance    |")
    print("======================================================")
    ...
    for i in range(1, iterations):
        if found != [True for i in range(nbPlayers)]:#utiliser pour calculer le nombre d'iteration totale
            iteration+=1
    ...
    print("scores:", score)
    print("time "  + str(t2 - t1) + "iteration " + str(iteration))
    pygame.quit()
